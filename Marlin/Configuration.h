...
#define STRING_CONFIG_H_AUTHOR "Techknowdude, Crearibo SKR V1.4 Turbo" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Crearibo 1.4 Turbo"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 131 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 20, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.32 }
